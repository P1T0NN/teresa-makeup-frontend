...
<CalendarPrimitive.Day
	bind:ref
	class={cn(
		"flex h-(--cell-height,var(--cell-size)) w-(--cell-width,var(--cell-size)) flex-col items-center justify-center gap-1 rounded-(--cell-radius) p-0 leading-none font-normal whitespace-nowrap select-none",
